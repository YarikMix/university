...
const groupEditFormSlice = createSlice({
    name: 'groupEditForm',
...
export const {updateOpen, updateGroup, updateGroupName, updateCourse, updateEducationType, updateFaculty, updateYearBegin, updateYearEnd} = groupEditFormSlice.actions;

export default groupEditFormSlice.reducer;